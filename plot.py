...
ax1.errorbar(read_data[0], (read_data[3]), fmt="k-s")
ax1.set_ylabel("Energy")
ax1.set_xlabel("kT")
# ax1.set_ylim(ax1.get_ylim()[0], 0)

ax2.errorbar(read_data[0], (read_data[4]), fmt="k-s")
...
ax4.errorbar(read_data[0], (read_data[5]), yerr=read_data[6], fmt="k-s", capsize=3)
